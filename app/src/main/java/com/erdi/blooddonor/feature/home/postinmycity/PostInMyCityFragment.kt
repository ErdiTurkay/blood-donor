package com.erdi.blooddonor.feature.home.postinmycity
...
import com.erdi.blooddonor.databinding.FragmentPostInMyCityBinding
...
@AndroidEntryPoint
class PostInMyCityFragment : Fragment(), PostClickListener {
    private lateinit var binding: FragmentPostInMyCityBinding
    ...
    private fun setBloodAdRV() {
        ...
        viewModel.postInMyCityResponse.observe(viewLifecycleOwner) {
            when (it) {
